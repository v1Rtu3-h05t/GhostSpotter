...
Actual example demonstrating password cracking with a SHA512 hash:
...
> **Note:** When using brute-force mode, adjust `--min_length` & `--max_length` to suit your needs. The values 4 & 6 were just for this demonstration.
